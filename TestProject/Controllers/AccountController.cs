...
namespace TestProject.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        *//*            _userManager = userManager;*//*
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl = "/Home/Index")
        {
            ...
            /*            if (! (await _userService.FindAsync(model.Email, model.Password)))
                        {
                            return View("Lockout");
                        }
                        else
            ...
            {
                ClaimsIdentity ident = await _userService.CreateIdentity(user, DefaultAuthenticationTypes.ApplicationCookie);
 //               AuthenticationManager.SignOut();
        ...
        {
            return View(new RegisterViewModel(_roleService));
        }
